...
public class ActionBarHelperBase extends ActionBarHelper {
  ...
  private void setupActionBar() {
    ...
    homeItem.setIcon(R.drawable.ic_launcher_logo);
   ...
   * {@link se.acrend.christopher.android.activity.actionbar.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}
   * .
   */
  ...
  private class WrappedMenuInflater extends MenuInflater {
    ...
    /**
     * Loads action bar metadata from a menu resource, storing a list of menu
     * item IDs that should be shown on-screen (i.e. those with showAsAction set
     * to always or ifRoom).
     * 
     * @param menuResId
     */
